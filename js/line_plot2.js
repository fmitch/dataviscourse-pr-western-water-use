...
class LinePlot2 {
     ...
     */
    constructor(data,updateAllLine2) {
        ...
        this.updateAllLine2 = updateAllLine2;
    ...
    drawPlot(viewer) {
        ...
        yWrap.append('div').attr('id', 'dropdown_y-line2').classed('dropdown', true).append('div').classed('dropdown-content', true)
            .append('select');
